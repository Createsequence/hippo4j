...
import cn.hippo4j.core.plugin.manager.DefaultGlobalThreadPoolPluginPublisher;
...
/**
 * <p>The extension implementation of {@link GlobalThreadPoolPluginPublisher} and {@link BeanPostProcessor},
 ...
 * @see DefaultGlobalThreadPoolPluginPublisher
 * @see ContextRefreshedEvent
 */
@Slf4j
public class ThreadPoolPluginRegisterPostProcessor extends DefaultGlobalThreadPoolPluginPublisher
     ...
     * If the {@link ContextRefreshedEvent} has been published, the component will complete the registration immediately.
     *
    ...
    public Object postProcessAfterInitialization(Object bean, String beanName) throws BeansException {
        ...
        if (ThreadPoolPluginSupport.class.isAssignableFrom(beanType)) {
            ...
            isNewSupport = getRegisteredThreadPoolPluginSupports().add(support);
