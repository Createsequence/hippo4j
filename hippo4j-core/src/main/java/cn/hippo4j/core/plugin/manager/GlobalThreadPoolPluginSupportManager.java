...
/**
 * Globally manager of {@link ThreadPoolPluginSupport}.
 */
public interface GlobalThreadPoolPluginSupportManager {
     ...
     * thrown when the thread pool id is same as the id of the registered {@link ThreadPoolPluginSupport}
     */
    void registerSupport(@NonNull ThreadPoolPluginSupport support);
     ...
     */
    @Nullable
    ThreadPoolPluginSupport getSupport(String threadPoolId);
     ...
     */
    @Nullable
    ThreadPoolPluginSupport unregisterSupport(String threadPoolId);
     ...
     */
    Collection<ThreadPoolPluginSupport> getAllSupports();
