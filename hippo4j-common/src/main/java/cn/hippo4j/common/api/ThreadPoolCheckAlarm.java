...
public interface ThreadPoolCheckAlarm extends CommandLineRunner {
    ...
    /**
     * Get an empty thread pool check alarm.
     *
     * @return {@link ThreadPoolCheckAlarm}
     * @see EmptyThreadPoolCheckAlarm
     */
    static ThreadPoolCheckAlarm empty() {
        return EmptyThreadPoolCheckAlarm.INSTANCE;
    }
    ...
    /**
     * Empty implementation of {@link ThreadPoolCheckAlarm}.
     *
     * @see #empty()
     */
    @Slf4j
    @NoArgsConstructor(access = AccessLevel.PRIVATE)
    class EmptyThreadPoolCheckAlarm implements ThreadPoolCheckAlarm {

        /**
         * Default singleton.
         */
        private static final EmptyThreadPoolCheckAlarm INSTANCE = new EmptyThreadPoolCheckAlarm();
